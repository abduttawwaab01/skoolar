...
export function CertificateHistory() {
  ...
  const handleDownload = async (cert: typeof issuedCertificates[0]) => {
    ...
    const data = buildCertificateRenderData({
      ...
      schoolName: cert.design.schoolName || 'School Name',
      schoolLogo: cert.design.schoolLogoUrl || undefined,
      schoolAddress: cert.design.schoolAddress || '',
      schoolMotto: cert.design.schoolMotto || '',
      principalName: cert.design.principalName || 'Principal',
      design: cert.design,
