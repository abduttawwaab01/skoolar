  ...
  const updatePreview = useCallback(async () => {
    ...
    try {
      ...
      const data = buildCertificateRenderData({
        ...
        attendance: 'N/A',
        subjects: [],
        schoolName: design.schoolName || 'School Name',
        schoolLogo: design.schoolLogoUrl || undefined,
        schoolAddress: design.schoolAddress || 'School Address',
        schoolMotto: design.schoolMotto || 'School Motto',
        principalName: design.principalName || 'Principal',
        design,
