      ...
      const res = await fetch('/api/id-cards/preview', {
        ...
        body: JSON.stringify({
          ...
          design: {
            ...
            showClass: design.showClass,
            showSection: design.showSection,
            showSession: design.showSession,
            showPhone: design.showPhone,
          ...
          <TabsContent value="elements" className="space-y-2.5 mt-2">
            <Card className="p-3 space-y-3">
              ...
              {[
                ...
                { key: 'showClass' as const, label: 'Class (Student)' },
                { key: 'showSection' as const, label: 'Section' },
                { key: 'showSession' as const, label: 'Session' },
