...
function AnnouncementsTab() {
  ...
  const fetchItems = useCallback(async () => {
   ...
   const handleDelete = async (id: string) => {
     const ok = await confirm('Are you sure you want to delete this announcement? This action cannot be undone.');
     if (!ok) return;
     try {
...
function AdvertsTab() {
  ...
  const handleSave = async () => {
   ...
   const handleDelete = async (id: string) => {
     const ok = await confirm('Are you sure you want to delete this advert? This action cannot be undone.');
     if (!ok) return;
     try {
...
function PreloaderTab() {
  ...
  const handleSave = async () => {
   ...
   const handleDelete = async (id: string) => {
     const ok = await confirm('Are you sure you want to delete this quote? This action cannot be undone.');
     if (!ok) return;
     try {
...
function StoriesTab() {
  ...
  const handleSave = async () => {
   ...
   const handleDelete = async (id: string) => {
     const ok = await confirm('Are you sure you want to delete this story? This action cannot be undone.');
     if (!ok) return;
     try {
