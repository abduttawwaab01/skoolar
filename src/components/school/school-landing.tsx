...
import { getSchoolDomain, parseSectionVisibility } from '@/lib/school-utils';
import { FeatureCardsSection, renderExtraSections } from './content-blocks';
...
export function SchoolLanding({ school }: { school: SchoolProfile }) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {visibility.extraSections && renderExtraSections(school.extraSections)}
    </div>
  );
}
