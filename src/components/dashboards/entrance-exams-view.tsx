...
export function EntranceExamsView() {
  ...
  const toggleActive = async (id: string, current: boolean) => {
   ...
   const deleteExam = async (id: string) => {
     const ok = await confirm('Are you sure you want to delete this exam? Applicants with the code will no longer be able to access it. This action cannot be undone.');
     if (!ok) return;
     try {
