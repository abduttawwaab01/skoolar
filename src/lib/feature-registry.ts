...
export const PLATFORM_FEATURES: FeatureDef[] = [
  ...
  { id: 'teacher_performance', label: 'Teacher Performance', icon: TrendingUp, description: 'Teacher performance tracking (gated by Teacher Tasks)' },
  { id: 'student_leaderboard', label: 'Leaderboard', icon: Award, description: 'Gamification and student leaderboards (gated by Achievements)' },
  ...
  // ─── Missing Subsystem Features ───
  { id: 'assessment_hub', label: 'Assessment Hub', icon: ClipboardPen, description: 'Student and teacher assessments, 360 feedback, observations, competency' },
  { id: 'certificates', label: 'Certificates', icon: ScrollText, description: 'Certificate design, generation, and history' },
  { id: 'behaviour_chart', label: 'Behaviour Chart', icon: ChartColumnStacked, description: 'Behaviour chart tracking and management' },
  { id: 'handwriting', label: 'Handwriting Sheets', icon: Pen, description: 'Handwriting practice sheet generation' },
  { id: 'math_drills', label: 'Math Fact Drills', icon: Calculator, description: 'Math drill practice and exercises' },
  { id: 'spelling', label: 'Spelling & Vocabulary', icon: FileText, description: 'Spelling practice and vocabulary exercises' },
  { id: 'id_cards', label: 'ID Cards', icon: IdCard, description: 'ID card design, printing, and QR scanning' },
...
export const viewToFeatureMap: Record<string, FeatureId> = {
  ...
  // ─── New subsystem feature mappings ───
  'assessment-hub': 'assessment_hub',
  'assessment-student-list': 'assessment_hub',
  'assessment-student-create': 'assessment_hub',
  'assessment-student-take': 'assessment_hub',
  'assessment-student-results': 'assessment_hub',
  'assessment-student-profile': 'assessment_hub',
  'assessment-student-growth': 'assessment_hub',
  'assessment-teacher-list': 'assessment_hub',
  'assessment-teacher-create': 'assessment_hub',
  'assessment-teacher-take': 'assessment_hub',
  'assessment-teacher-results': 'assessment_hub',
  'assessment-teacher-competency': 'assessment_hub',
  'assessment-360-feedback': 'assessment_hub',
  'assessment-observations': 'assessment_hub',
  'assessment-templates': 'assessment_hub',
  'assessment-analytics-view': 'assessment_hub',
  'certificates': 'certificates',
  'certificate-print': 'certificates',
  'student-certificates': 'certificates',
  'parent-certificates': 'certificates',
  'behaviour-chart': 'behaviour_chart',
  'student-behaviour-chart': 'behaviour_chart',
  'parent-behaviour-chart': 'behaviour_chart',
  'handwriting-sheets': 'handwriting',
  'student-handwriting': 'handwriting',
  'parent-handwriting': 'handwriting',
  'math-drills': 'math_drills',
  'spelling-practice': 'spelling',
  'id-cards': 'id_cards',
  'id-scanner': 'id_cards',
  'student-id-cards': 'id_cards',
  'parent-id-cards': 'id_cards',
  'teacher-id-cards': 'id_cards',
  'super-id-cards': 'id_cards',
  'salary': 'salary',
  ...
  'student-exams': 'exams',
  'parent-exams': 'exams',
  'student-video-lessons': 'video_lessons',
  'parent-video-lessons': 'video_lessons',
  'student-timetable': 'timetable',
  'parent-timetable': 'timetable',
  'parent-analytics': 'analytics',
  'student-analytics': 'analytics',
  'parent-finance': 'fee_management',
  'staff-self-attendance': 'staff_attendance',
  'student-report-cards': 'report_cards',
};
