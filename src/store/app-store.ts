...
export type DashboardView = 
  | 'overview' | 'super-admin-dashboard' | 'school-admin-dashboard' | 'teacher-dashboard' | 'schools' | 'registration-codes' | 'academic-structure' 
...
export const navigationByRole: Record<UserRole, NavItem[]> = {
  SUPER_ADMIN: [
    ...
    SCHOOL_ADMIN: [
      { id: 'school-admin-dashboard', label: 'Dashboard', icon: 'layout-dashboard' },
   ...
   TEACHER: [
      { id: 'teacher-dashboard', label: 'Dashboard', icon: 'layout-dashboard' },
