  ...
  try {
    ...
    if (clientDesign) {
      designState = {
        ...
        showClass: clientDesign.showClass !== undefined ? clientDesign.showClass : true,
        showSection: clientDesign.showSection !== undefined ? clientDesign.showSection : false,
        showSession: clientDesign.showSession !== undefined ? clientDesign.showSession : false,
        showPhone: clientDesign.showPhone !== undefined ? clientDesign.showPhone : false,
