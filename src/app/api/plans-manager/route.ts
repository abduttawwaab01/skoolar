  ...
  try {
    ...
    const plan = await db.subscriptionPlan.update({
      ...
      data: {
        ...
        ...(data.hasLibrarianPortal !== undefined && { hasLibrarianPortal: data.hasLibrarianPortal }),
        ...(data.hasParentPortal !== undefined && { hasParentPortal: data.hasParentPortal }),
        ...(data.hasAIFeatures !== undefined && { hasAIFeatures: data.hasAIFeatures }),
        ...(data.hasPremiumSupport !== undefined && { hasPremiumSupport: data.hasPremiumSupport }),
        ...(data.hasPartnership !== undefined && { hasPartnership: data.hasPartnership }),
